...
BGM(0) = "F:\QBX\CRICKET\MUSIC\TechDemoTheme.mp3"
...
SEF(0) = _SNDOPEN("F:\QBX\CRICKET\SOUND\FlameWareLogo.ogg", "VOL,SYNC")
SEN(0) = "FlameWare Logo Theme -- Xmuzik"
SEF(1) = _SNDOPEN("F:\QBX\CRICKET\SOUND\CKJump.ogg", "VOL,SYNC")
...
SEF(2) = _SNDOPEN("F:\QBX\CRICKET\SOUND\GFSNESBell.ogg", "VOL,SYNC")
SEN(2) = "Cricket Gets a 1UP -- Temporary"
SEF(3) = _SNDOPEN("F:\QBX\CRICKET\SOUND\CKDeathSymphony.ogg", "VOL,SYNC")
SEN(3) = "Cricket Dies -- L. von Beethoven, Musopen"
SEF(4) = _SNDOPEN("F:\QBX\CRICKET\SOUND\CKVertMalletSwing.ogg", "VOL,SYNC")
...
SEF(8) = _SNDOPEN("F:\QBX\CRICKET\SOUND\CKHorizMalletSwing.ogg", "VOL,SYNC")
...
SEF(13) = _SNDOPEN("F:\QBX\CRICKET\SOUND\Alert3Pause.ogg", "VOL,SYNC")
SEN(13) = "Pause or Unpause the Game -- freesfx.co.uk"
SEF(14) = _SNDOPEN("F:\QBX\CRICKET\SOUND\ClockTIck.ogg", "VOL,SYNC")
SEN(14) = "Remaining Time Converted to Points"
SEF(15) = _SNDOPEN("F:\QBX\CRICKET\SOUND\TimeRunningOut.ogg", "VOL,SYNC")
SEN(15) = "Time is Running Out"
SEF(16) = _SNDOPEN("F:\QBX\CRICKET\SOUND\TimeUpBuzzer.ogg", "VOL,SYNC")
SEN(16) = "Out of Time"
...
DO
    ...
    FOR Foot = 0 TO (sn - 1) 'The number of sprites below Cricket's feet
        IF LevelData(vert% + PRow, UnderFoot(Foot)) = 1 THEN 'Platform
            IF jump% = -2 THEN oco = oco + 1 ELSE jdrop = 0: jump% = 0
        ...
        CASE 13 ' ENTER
            SELECT CASE Highlight 'A tiny bit of code optimization, here.
                ...
                CASE 4 'Start > Subcon 1
                    ...
                    BGM(0) = "F:\IMPULSE\SOTRFALT.IT"
                    BGM(1) = "F:\QBX\CRICKET\MUSIC\SubUnderworld.mp3"
                    BGM(2) = "F:\QBX\CRICKET\MUSIC\Birdo.mp3"
                    bgm& = _SNDOPEN(BGM(0), "VOL,PAUSE")
                    EXIT DO
