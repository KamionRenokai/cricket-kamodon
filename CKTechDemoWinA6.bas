...
ckJump& = _SNDOPEN("F:\BonusOpen.ogg", "VOL,SYNC")
ckSwing1& = _SNDOPEN("F:\snare.wav", "VOL,SYNC")
ckSwing2& = 0
ckSwing3& = 0
ckExtraLife& = _SNDOPEN("F:\GFSNESBell.ogg", "VOL,SYNC")
ckHurt& = 0
'ckDeath& = _SNDOPEN("/media/FreeAgent GoFlex Drive/KINGPICCOLO/Users/The Namek/Documents/Stop On A Whammy!.wav", "VOL,SYNC")
ckPause& = _SNDOPEN("F:\SQPauseSound.ogg", "VOL,SYNC")
ckTimeLow& = _SNDOPEN("F:\TimeRunningOut.ogg", "VOL,SYNC")
ckTimeUp& = 0
...
IF _FILEEXISTS("F:\QBX\CRICKET\WLDXL1FG.KMD") THEN
    OPEN "F:\QBX\CRICKET\WLDXL1FG.KMD" FOR INPUT AS #1 'Mushroom 1 foreground
...
IF _FILEEXISTS("F:\QBX\CRICKET\WLDXL1B1.KMD") THEN
    OPEN "F:\QBX\CRICKET\WLDXL1B1.KMD" FOR INPUT AS #2
...
IF _FILEEXISTS("F:\QBX\CRICKET\WLDXL1S0.KMD") THEN
    OPEN "F:\QBX\CRICKET\WLDXL1S0.KMD" FOR INPUT AS #4
...
OPEN "F:\QBX\CRICKET\WLDXL1FG.KMD" FOR INPUT AS #1
OPEN "F:\QBX\CRICKET\WLDXL1B1.KMD" FOR INPUT AS #2
OPEN "F:\QBX\CRICKET\WLDXL1B2.KMD" FOR INPUT AS #3
OPEN "F:\QBX\CRICKET\WLDXL1S0.KMD" FOR INPUT AS #4
...
lc% = (grab / 22) / 255 'How many times does the total go into 255?
...
fwlogo& = _SNDOPEN("F:\FlameWareLogoSlow.ogg")
_SNDPLAY fwlogo&
FadePal 1, Pal&()
CheckThat! = TIMER
DO
