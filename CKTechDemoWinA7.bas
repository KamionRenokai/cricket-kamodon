...
ckJump& = _SNDOPEN("F:\Mario_Jumping-Mike_Koenig.wav", "VOL,SYNC")
...
ckSwing1& = _SNDOPEN("F:\punch_or_whack_-Vladimir.wav", "VOL,SYNC")
ckSwing2& = 0
ckSwing3& = 0
ckExtraLife& = _SNDOPEN("F:\GFSNESBell.ogg", "VOL,SYNC")
ckPause& = _SNDOPEN("F:\Alert3Pause.ogg", "VOL,SYNC")
ckHurt& = _SNDOPEN("F:\SQPauseSound.ogg", "VOL,SYNC")
ckDeath& = _SNDOPEN("F:\CKDeathSymphony.ogg", "VOL,SYNC")
ckTimeLow& = _SNDOPEN("F:\TimeRunningOut.ogg", "VOL,SYNC")
ckTimeUp& = _SNDOPEN("F:\TimeUpBuzzer.ogg", "VOL,SYNC")
...
DO
	...
	CKB% = CKB% + 3 '   platform it was on, one pixel at a time.
...
fwlogo& = _SNDOPEN("F:\Xmuzik8290-FlameWareLogo.ogg")
_SNDPLAY fwlogo&
FadePal 1, Pal&()
CheckThat! = TIMER
DO
...
FileNum = FREEFILE
'TODO: I should seriously put a _FILEEXISTS statement in here!
